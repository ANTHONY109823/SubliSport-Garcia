        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GarmentType = table.Column<string>(type: "character varying(120)", maxLength: 120, nullable: false),
                    Sport = table.Column<string>(type: "character varying(80)", maxLength: 80, nullable: false),
                    Quantity = table.Column<int>(type: "integer", nullable: false),
                    SizeRange = table.Column<string>(type: "character varying(80)", maxLength: 80, nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Orders_AspNetUsers_AssignedDesignerId",
                        column: x => x.AssignedDesignerId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Orders_AgreedDeliveryDate",
                table: "Orders",
                column: "AgreedDeliveryDate");

            migrationBuilder.CreateIndex(
                name: "IX_Orders_AssignedDesignerId",
                table: "Orders",
                column: "AssignedDesignerId");
